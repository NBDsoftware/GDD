...
elif os.path.exists(os.path.join(file_dir, "..", "workdir", "p.npy")):
    p_ = np.load(os.path.join(file_dir, "..", "workdir", "p.npy"))
    score_ = np.load(os.path.join(file_dir, "..", "workdir", "score.npy"))
else:
