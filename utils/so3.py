...
elif os.path.exists(os.path.join(file_dir, "..", "workdir", "so3_omegas_array2.npy")):
    _omegas_array = np.load(os.path.join(file_dir, "..", "workdir", "so3_omegas_array2.npy"))
    _cdf_vals = np.load(os.path.join(file_dir, "..", "workdir", "so3_cdf_vals2.npy"))
    _score_norms = np.load(os.path.join(file_dir, "..", "workdir", "so3_score_norms2.npy"))
    _exp_score_norms = np.load(os.path.join(file_dir, "..", "workdir", "so3_exp_score_norms2.npy"))
else:
